...
<img width="800" height="600" alt="penglings_ggplot" src="penglings_r/penglings_ggplot.png" />
...
<br>
<br>
For this plot, in R Script, I used the "geom_point()" layer and added features using "scale_()" layers for the color and size and "labs()" for the titles, axis labels, and legend labels. Since I have been using R for several years, the code I utilized was from my own work, but when I need a reference for "ggplot," I refer to the "R Graphics Cookbook: Practical Recipes for Visualizing Data" by Winston Chang.

## d3 & JavaScript

<img width="800" height="600" alt="penglings_d3" src="penglings_js/penglings_d3.png" />
...
<img width="800" height="600" alt="penglings_python_ss" src="penglings_py/penglings_python.png" />
...
<img width="800" height="600" alt="penglings_excel" src="penglings_excel/penglings_excel.png" />
...
<br>
<br>
<img width="800" height="600" alt="penglings_excel_bubble_size" src="penglings_excel/penglings_excel_bubble.png" />
...
<img width="650" height="600" alt="penglings_datawrapper_2" src="penglings_dw/penglings_datawrapper.png" />
...
<img width="800" height="600" alt="penglings_tableau" src="penglings_tableau/penglings_tableau.png" />
...
<img width="1000" height="600" alt="penglings_flourish" src="penglings_flourish/penglings_flourish.png" />
...
<img width="800" height="600" alt="penglings_d3_hover" src="penglings_js/penglings_d3_hover.png" />
