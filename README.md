...
<br>
<br>
Like "ggplot," I like the syntax of the "chart" function using one block of code.
...
<br>
<br>
Excel was another tool that I found very easy to use due to years of experience. However, it does have limitations, like how I could not change the circle radii relative to "bill length." Further, to distinguish point colors by "species," it is not straightforward. There is no option to "tell" the plot to have color based on a categorical variable and you have to create cells with "#NA" for when a particular species was not related to the x-y values.
